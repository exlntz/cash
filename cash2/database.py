...
critical_errors.extend((all_errors)[2:10])
...
while k<lastcount:
    ...
    for item in event_type[k: stopcount]:
        ...
        k+=1
    with open('bankomat_data.json', 'w', encoding='utf-8') as file:
        file.write('')
...
for event in value:
    ...
    if event in all_errors:
        ...
        if value[index] in non_critical_errors:
...
with open('atmdata2.json', 'w', encoding='utf-8') as file:
